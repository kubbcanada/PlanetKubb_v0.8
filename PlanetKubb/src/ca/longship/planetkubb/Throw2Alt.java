...
public class Throw2Alt extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		...
		if (cbKing.isChecked()) {
			...
			GlobalVars.addToString("|Throw 2 player=" + spnPlayerNames.getSelectedItem().toString() + "\n");
			sTurnString = spnPlayerNames.getSelectedItem().toString() + ":K";
			GlobalVars.addToString("|Throw 2=K\n");
		...
		if (Turn2.getText().toString() == "Game Ended") {
			...
			GlobalVars.setCurrentTurnString();
			Intent throw3 = new Intent("ca.longship.planetkubb.THROW3ALT");
			startActivity(throw3);
			finish();
		}}
	}
