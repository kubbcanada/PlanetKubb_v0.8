...
public class TeamEntry extends Activity implements View.OnClickListener {
    ...
    private EditText etTeam1Name;
    private EditText etTeam2Name;
    private EditText etTeam1Players;
    private EditText etTeam2Players;
    private TextView tvErrorMsg;
    private Integer team1Players;
    private Integer team2Players;
    private EditText date;
    private EditText location;
    private EditText event;
    private EditText pitch;
    private EditText scoredby;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button nextTeam = (Button) findViewById(R.id.bTeam1);
