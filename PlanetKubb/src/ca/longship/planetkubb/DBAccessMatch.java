...
public class DBAccessMatch {
    ...
    private static final String KEY_T1P2 = "t1p2";
    private static final String KEY_T1P3 = "t1p3";
    private static final String KEY_T1P4 = "t1p4";
    private static final String KEY_T1P5 = "t1p5";
    private static final String KEY_T1P6 = "t1p6";
    private static final String KEY_T2P1 = "t2p1";
    private static final String KEY_T2P2 = "t2p2";
    private static final String KEY_T2P3 = "t2p3";
    private static final String KEY_T2P4 = "t2p4";
    ...
    private static final String KEY_KUBBINKAST = "kubb_inkast";
    private static final String KEY_PLAYERINKAST = "player_inkast";
    private static final String KEY_ADVANTAGE = "advantage";
    private static final String KEY_THROW1PLAYER = "throw1_player";
    private static final String KEY_THROW1 = "throw1";
    private static final String KEY_THROW2PLAYER = "throw2_player";
    private static final String KEY_THROW2 = "throw2";
    private static final String KEY_THROW3PLAYER = "throw3_player";
    private static final String KEY_THROW3 = "throw3";
    private static final String KEY_THROW4PLAYER = "throw4_player";
    private static final String KEY_THROW4 = "throw4";
    private static final String KEY_THROW5PLAYER = "throw5_player";
    ...
    private static final String KEY_PLAYERINITIALS = "player_initials";
    ...
    public ArrayList<String> getTurnEditInfo(String[] matchID) {
        ...
        if (c.getCount() > 0) {
            ...
            for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
                if (c.getString(iAdvantage).equals("True")) {
                    sAdvant = "A";
                } else {
                    sAdvant = " ";
                }
            ...
            if (c != null) {
                ...
                for (c.moveToFirst(); !c.isAfterLast(); c.moveToNext()) {
                    ...
                    sMatchInfo = sMatchInfo + "|Kubb throw 1 player="
                            + c.getString(iPlayerInkast) + "\n"
                            + "|Kubb throw 1="
                            + c.getString(iKubbInkast) + "\n"
                            + "|Advantage line="
                            + c.getString(iAdvantage) + "\n"
                            + "|Throw 1 player="
                            + c.getString(iThrow1Player) + "\n"
                            + "|Throw 1=" + c.getString(iThrow1)
                            + "\n" + "|Throw 2 player="
                            + c.getString(iThrow2Player) + "\n"
                            + "|Throw 2=" + c.getString(iThrow2)
                            + "\n" + "|Throw 3 player="
                            + c.getString(iThrow3Player) + "\n"
                            + "|Throw 3=" + c.getString(iThrow3)
                            + "\n" + "|Throw 4 player="
                            + c.getString(iThrow4Player) + "\n"
                            + "|Throw 4=" + c.getString(iThrow4)
                            + "\n" + "|Throw 5 player="
                            + c.getString(iThrow5Player) + "\n"
    ...
    String getPlayerInitials(String playername) {
