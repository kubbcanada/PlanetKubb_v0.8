...
public class MatchEdit extends Activity implements View.OnTouchListener {
    ...
    private ListView matchEditList;
    private final String[] matchID = {"0"};
    private String sTurnToEdit;
    ...
    private final DBAccessMatch db = new DBAccessMatch(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView matchEditTitle = (TextView) findViewById(R.id.tvMatchEditTitle);
...
//		DBAccessMatch db = new DBAccessMatch(this);
        db.open();
        String[] columns1 = new String[]{DBAccessMatch.KEY_MATCHID, DBAccessMatch.KEY_EVENTNAME,
                DBAccessMatch.KEY_DATE};

        String[] almatchinfo = db.getMatchInfo(columns1, matchID);
        matchEditTitle.setText("Match : " + almatchinfo[0] + " - "
                + almatchinfo[1] + " - " + almatchinfo[2]);

        ArrayList<String> TList = db.getTurnInfo(matchID);
...
//		matchEditTitle.setClickable(true);
    ...
    void editThisMatch(String thisMatchID, String turnID) {
