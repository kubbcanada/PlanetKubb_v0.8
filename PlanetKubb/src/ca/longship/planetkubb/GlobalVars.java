...
class GlobalVars extends Application {
    ...
    private static String sT1P4In;
    private static String sT1P5In;
    private static String sT1P6In;
    private static String sT2P1In;
    private static String sT2P2In;
    private static String sT2P3In;
    ...
    private static final String[] sTeam2PlayerNames = {"Player 1", "Player 2", "Player 3",
            "Player 4", "Player 5", "Player 6"};
    private static final String[] sTeam1PlayerInit = {"", "", "", "", "", ""};
    private static final String[] sTeam2PlayerInit = {"", "", "", "", "", ""};
    static Integer sTeam1PlayNum, sTeam2PlayNum;
    private static String[] sTurnText;
    private static Integer iTurnNumber;
    static Integer iTurn = 1;
    static String sCurrentTeam = "Team 1";
    static Boolean bAdvantage = false;
    private static Boolean bAdv = false;
    ...
    private static Integer iTurn2Thrown = 0;
    private static Integer iTurn3Thrown = 0;
    private static Integer iTurn4Thrown = 0;
    private static Integer iTurn5Thrown = 0;
    private static Integer iTurn6Thrown = 0;
    static String sStartDate, sLocation, sEvent, sPitchSurface, sScoredBy;
    private static int kubbsKnockedDownLastTurn = 0;
    private static int iTeam1BaseKubbs = 0;
    private static int iTeam1FieldKubbs = 0;
    private static int iTeam2BaseKubbs = 0;
    private static int iTeam2FieldKubbs = 0;

    static String sTurn1Hit = "-", sTurn2Hit = "-", sTurn3Hit = "-",
            sTurn4Hit = "-", sTurn5Hit = "-", sTurn6Hit = "-";
    private static String sCurrentTurnFinal;
    private static String sCurrentTurn;
    private static int lastBaseKubbs = 0;
    private static int lastFieldKubbs = 0;
    ...
    public static void setTeam1PlayerNames(String team1PlayerName, int position) {
        sTeam1PlayerNames[position] = team1PlayerName;
    ...
    public static void setTeam2PlayerNames(String team2PlayerName, int position) {
        sTeam2PlayerNames[position] = team2PlayerName;
        addToString("{{Game player\n|Team=" + sTeam2Name + "\n|Player="
    ...
    public static void setTeam() {
        ...
        if (sCurrentTeam.equals(sTeam1Name)) {
    ...
    public static void setCurrentTurnString() {
        ...
        if (!sTurn1Player.equals(" ") || sTurn1Player != null) {
        ...
        if (!sTurn2Player.equals(" ") || sTurn2Player != null) {
        ...
        if (!sTurn3Player.equals(" ") || sTurn3Player != null) {
        ...
        if (!sTurn4Player.equals(" ") || sTurn4Player != null) {
        ...
        if (!sTurn5Player.equals(" ") || sTurn5Player != null) {
        ...
        if (!sTurn6Player.equals(" ") || sTurn6Player != null) {
